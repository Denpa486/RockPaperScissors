...
for (let t = 0; t < 6; t++) {
  ...
  const s = await page.evaluate(() => {
    ...
    return { phase: g.phase, hp: g.player ? g.player.hp : 0, combo: g.player ? g.player.combo : [], bMoves: g.bossMoves, gesture: g.player ? g.player.gesture : null };
  });
